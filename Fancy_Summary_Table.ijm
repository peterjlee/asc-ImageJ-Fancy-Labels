/* Inspired by the BAR ROI_Color_Coder.ijm
	...
	v220808 Better anti-aliasing  f1-f4: updated color functions. F5: Updated indexOf functions. F6: getColorArrayFromColorName_v230908.  F12 : Replaced function: pad. F13: Updated getColorFromColorName function (012324).
 */
macro "Add Summary Table to Copy of Image"{
	macroL = "Fancy_Summary_Table_v220808-f13.ijm";
	requires("1.47r");
	saveSettings;
