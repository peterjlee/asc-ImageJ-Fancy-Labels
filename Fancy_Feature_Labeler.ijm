/* Inspired by ROI_Color_Coder.ijm
	...
	+ v211022 Updated color choices  f5: updated functions f6: updated colors Replaced binary[-]Check with toWhiteBGBinary f7-8: updated colors f10-11: updated functions. F12: getColorArrayFromColorName_v230908.  F17 : Replaced function: pad. F18: Updated function checkForRoiManager_v231211. F19: Updated getColorFromColorName function (012324).
 */
macro "Add scaled value labels to each ROI object"{
	macroL = "Fancy_Feature_Labeler_v211022-f19.ijm";
	requires("1.47r");
	saveSettings;
	/* Some cleanup */
	run("Select None");
